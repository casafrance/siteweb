						...
						<div class="aa-header-top-area">
							...
							<div class="aa-header-top-right">
								<ul class="aa-head-top-nav-right">
									...
									<li><a href="" data-toggle="modal" data-target="#login-modal">Espace
											Pro</a></li>
...
<!-- 							</div> -->
				...
				<div class="navbar navbar-default" role="navigation">
					...
					<div class="navbar-collapse collapse">
						...
						<ul class="nav navbar-nav">
							...
							<li><a href="traitementCharpente.php">Traitement de charpente <span
									class="caret"></span></a></li>
							<li><a href="nettoyage.php">Nettoyage de toiture <span
									class="caret"></span></a></li>
	...
	<div class="form-style-10">
		<h1>
			Devis en ligne<span>Obtenez votre devis gratuit en quelques secondes</span>
		</h1>
		<div class="section">
			<span>4</span>Bravo votre devis est prêt
		</div>
		<table class="tableau">
			...
			<tbody>
				<tr>
					<td>- Nous avons estimé la durée des travaux à</td>
					<td><b><?php echo $_SESSION['jourdetravail'];?> </b> jour.</td>
					<td></td>
				</tr>
				<tr>
					<td>- Préparation des supports</td>
					<td></td>
				</tr>
				<tr>
					<td>- Protection des spots, boites de dérivation ,cheminée,
						appareillage autres</td>
					<td></td>
				</tr>
				<tr>
					<td>- Entourage de trappes coffrage en osb</td>
					<td></td>
				</tr>
				<tr>
					<td>- Soufflage laine de roche 32 cm R 7 jetrock2</td>
					<td></td>
				</tr>
				<tr>
					<td>- Contrat sérénité 10 ans inclus</td>
					<td></td>
				</tr>
				<tr>
					<td>- Nous allons rechercher pour vous un artisan dans votre
						secteur</td>
					<td></td>
				</tr>
				<tr>
					<td><b>Votre budget : </b></td>
					<td><span style="color: blue;"> <?php echo $budget;?>  euros TTC</span></td>
				</tr>
			</tbody>
		</table>
		...
		<form method="post" action="checkout.php">
			<div class="section">
				<span>5</span>Choisissez vos disponibilités
			</div>
			<div class="inner-wrap">
				<label><b>Choisissez vos disponibilités pour le passage du metreur </b><input
					type="date" name="datemetrage" required="required" /><br>
				<input type="time" name="heuremetrage" value="11:00" /></label> <label><b>Indiquez
						vos disponibilité pour la date des travaux </b><input type="date"
					name="datedemarragetravaux" required="required" /></label>
			</div>
