...
<input type="email" id="RegisterType_email" name="pseudo" required="required" class="form-control" placeholder="Email" /><i class="fa fa-envelope"></i></div><div class="form-group">
<input type="password" id="RegisterType_clearPassword" name="password" required="required" class="form-control" placeholder="Mot de passe" /><br>
<input type="submit" name="submit" class="button button-primary width-100" style="background-color : #000080 !important" id="buttonRegister" value="Login"></input></div></form></div></div></div></div>
