         ...
         <div class="cart-view-area">
           <div class="cart-view-table">
                      ...
                      <tr>
                        <td colspan="6" class="aa-cart-view-bottom">
                          <div class="aa-cart-coupon">
                            <input class="aa-coupon-code" type="text" placeholder="Code promotion">
                            <input class="aa-cart-view-btn" type="submit" value="Appliquer promotion">
                          </div>
                          <input class="aa-cart-view-btn" type="submit" value="Modifier mon panier">
                        </td>
                      </tr>
                      </tbody>
                  </table>
             ...
             <div class="cart-view-total">
               ...
               <a href="#" class="aa-cart-view-btn">Paiement sécurisé</a>
             </div>
           </div>
         </div>
       </div>
